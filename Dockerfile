...
RUN \
   ...
   pip install --no-cache git+https://github.com/khulnasoft/nativeauthenticator@9859a69dcc9d2ae8d827f192a1580d86f897e9f1 && \
   ...
   pip install --no-cache /mlrecipesspawner && \
   rm -r /mlrecipesspawner && \
   pip install tornado==5.1.1 && \
   # Cleanup
   clean-layer.sh

### END MLRECIPES-SPECIFIC INSTALLATIONS ###
...
LABEL \
    ...
    "org.opencontainers.image.documentation"="https://github.com/khulnasoft/ml-recipes" \
    "org.opencontainers.image.url"="https://github.com/khulnasoft/ml-recipes" \
    "org.opencontainers.image.source"="https://github.com/khulnasoft/ml-recipes" \
    ...
    "org.label-schema.usage"="https://github.com/khulnasoft/ml-recipes" \
    "org.label-schema.url"="https://github.com/khulnasoft/ml-recipes" \
    "org.label-schema.vcs-url"="https://github.com/khulnasoft/ml-recipes" \
