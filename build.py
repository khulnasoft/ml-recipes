...
parser.add_argument('--name', help='name of docker container', default="ml-recipes")
...
chart_yaml = "./helmchart/mlrecipes/Chart.yaml"
values_yaml = "./helmchart/mlrecipes/values.yaml"
...
try:
    call("helm package ./helmchart/mlrecipes -d helmchart")
except:
