...
class MLRecipesKubernetesSpawner(KubeSpawner):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.default_label = {utils.LABEL_MLRECIPES_ORIGIN: self.hub_name, utils.LABEL_MLRECIPES_USER: self.user.name, utils.LABEL_MLRECIPES_SERVER_NAME: self.name, LABEL_POD_NAME: self.pod_name}
    ...
    def start(self):
        ...
        service = V1Service(
            ...
            spec = V1ServiceSpec(
                ...
                selector={
                    utils.LABEL_MLRECIPES_ORIGIN: self.extra_labels[utils.LABEL_MLRECIPES_ORIGIN], 
    ...
    # Override
    def get_state(self):
        state = super(MLRecipesKubernetesSpawner, self).get_state()
        state = utils.get_state(self, state)
        return state
    
    # Override
    def load_state(self, state):
        super(MLRecipesKubernetesSpawner, self).load_state(state)
