...
LABEL_MLRECIPES_ORIGIN = "mlrecipes.origin"
LABEL_MLRECIPES_USER = "mlrecipes.user"
LABEL_MLRECIPES_SERVER_NAME = "mlrecipes.server_name"
...
ENV_HUB_NAME = os.getenv("HUB_NAME", "mlrecipes")
